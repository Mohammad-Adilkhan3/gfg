<h2><a href="https://www.geeksforgeeks.org/problems/typecast-and-double-it--153103/1?page=1&category=Java&status=unsolved&sortBy=submissions">TypeCast And Double It</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an input <strong>num </strong>as a string. You need to <strong>typecast </strong>into an integer and <strong>double </strong>it.&nbsp;</span></p>
