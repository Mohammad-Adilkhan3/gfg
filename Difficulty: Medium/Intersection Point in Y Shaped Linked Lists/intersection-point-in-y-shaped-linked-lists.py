...
def intersetPoint(headA,headB):
    ...
    # Traverse the lists
    while p1 != p2:
        # Move each pointer to the next node, or switch to the other head if at the end
        p1 = p1.next if p1 else headB
        p2 = p2.next if p2 else headA

    # If they meet at some node, return that node's data; otherwise, they meet at None
